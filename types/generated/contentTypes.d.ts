...
export interface ApiHomePageHomePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    HomeHero: Attribute.Component<'layout.hero-section'>;
    FeaturedPost: Attribute.Component<'blog.featured-post'>;
    BlogSelection: Attribute.DynamicZone<
      ['blog.post-selection', 'blog.featured-post']
    > &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
